...
SIGINT.prototype.error = function(operation) {
	var returnVal = this._skeleton("e");
	returnVal.message.o = operation;

	returnVal.msg = function(value) {
		returnVal.message.d = returnVal.message.d || {};
		returnVal.message.d.msg = value;
		return returnVal;
	}

	returnVal.detail = function(value) {
		returnVal.message.d = returnVal.message.d || {};
		returnVal.message.d.detail = value;
		return returnVal;
	};
