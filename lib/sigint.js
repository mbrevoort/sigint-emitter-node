...
SIGINT.prototype.announce = function() {
	var returnVal = this._skeleton("announcement");
	returnVal.message.d = {version: "", stack: []};

	returnVal.stack_item = function(name) {
		return {
			version: function(value) {
				returnVal.message.d.stack.push({name: name, version: value});
				return returnVal;
			}
		};
	};
	...
	returnVal.app_version = function(value) {
		returnVal.message.d.version = value;
		return returnVal;
	}
...
SIGINT.prototype.count = function(operation) {
	var returnVal = this._skeleton("counter");
...
SIGINT.prototype.time = function(operation) {
	var returnVal = this._skeleton("timer");
	returnVal.message.o = operation;
